...
(function () {
    ...
    function open(opts) {
        ...
        if (opts.title) {
            ...
            Object.assign(h.style, { fontSize: '1.125rem', fontWeight: 700, marginBottom: '0.75rem' });
        ...
        if (opts.body !== undefined && opts.body !== null) {
            ...
            Object.assign(body.style, { marginBottom: '1.25rem', color: '#374151', fontSize: '0.9375rem', lineHeight: '1.5' });
            dialog.appendChild(body);
        }

        const actions = document.createElement('div');
        Object.assign(actions.style, { display: 'flex', justifyContent: 'flex-end', gap: '0.5rem' });
        ...
        // 默认聚焦确认按钮（危险操作时聚焦取消更安全，但首版统一聚焦确认可见）。
